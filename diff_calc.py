...
class DiffObj:
    ...
    def calculate_strain(self, prev, dtype):
        ...
        decay = math.pow(decay_base[dtype], time_elapsed / 1000.0)
        scaling = weight_scaling[dtype]
...
def calculate_difficulty(btmap, type, objects, radius):
    strain_step = 400
    prev = None
    max_strain = 0
    decay_weight = 0.9
